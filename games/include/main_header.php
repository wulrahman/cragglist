<div id="mainnav">
	...
	<div id="logo"><a href="<?=$setting["games_url"]?>"><img src="<?=$setting["games_url"]?>/files/img/logo.png"></img></a></div>
		...
		<nav class="pure-menu custom-restricted-width">
			...
			<ul class="pure-menu-list">
				...
				<li id="navbutton" class="pure-menu-has-children pure-menu-allow-hover">
					...
					<a href="#" id="menuLink1" class="pure-menu-link"><img src="<?=$setting["games_url"]?>/files/img/menu.png"></img></a>
